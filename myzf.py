...
job_name = "SSDzf_{}".format(resize)
# The name of the model. Modify it if you want.
model_name = "ZF_VOC2007_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/ZFNet/VOC2007/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/ZFNet/VOC2007/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/ZFNet/VOC2007/{}".format(job_name)
...
min_sizes = [min_dim * 10 / 100. - 10] + min_sizes
