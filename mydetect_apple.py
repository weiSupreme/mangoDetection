...
############################################################################################################
        path = r'apple/test_annotations_csv/'+file_name_list[i].rstrip('.png')+'.csv'
        #print 'csv path: ', path
...
#########################################################################################################          
        ...
        img.save('apple/detect_results/'+file_name_list[i])
...
def parse_args():
    ...
    parser.add_argument('--image_file', default='apple/test_images/')
    if VGG16 == 1:
        parser.add_argument('--model_def',
                            default='models/VGGNet/apple/apple300x300/deploy.prototxt')
        parser.add_argument('--model_weights',
                        default='models/VGGNet/apple/apple300x300/apple_apple300x300_iter_582.caffemodel')
    else:
        parser.add_argument('--model_def',
