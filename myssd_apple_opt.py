...
train_data = "data/VOCdevkit/VOC2007/lmdb/VOC2007_trainval_lmdb"
...
job_name = "apple_{}".format(resize)
# The name of the model. Modify it if you want.
model_name = "apple_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/VGGNet/apple/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/VGGNet/apple/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/apple/{}".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/VOCdevkit/results/apple/{}/Main".format(os.environ['HOME'], job_name)
...
max_sizes = [min_dim * 20 / 100. + 20] + max_sizes
...
det_out_param = {
    ...
    'share_location': share_location,
    'background_label_id': background_label_id,
    'nms_param': {'nms_threshold': 0.3, 'top_k': 400},  ########################0.45, 400   Finetuning
    'save_output_param': {
...
with open(job_file, 'w') as f:
  f.write('cd {}\n'.format(caffe_root))
  #f.write('GLOG_logtostderr=0 GLOG_log_dir=/home/zhuwei/Documents/SSD/log/ \\\n')
