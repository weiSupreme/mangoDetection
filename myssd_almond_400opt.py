...
job_name = "almond_tmp{}".format(resize)
# The name of the model. Modify it if you want.
model_name = "almond_tmp_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/VGGNet/almond_tmp/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/VGGNet/almond_tmp/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/almond_tmp/{}".format(job_name)
