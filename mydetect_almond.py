...
class CaffeDetection:
    ...
    def detect(self, image_file, conf_thresh=0.6, topn=25):  #0.5, 5
        '''
        SSD detection
        '''
...
def parse_args():
    ...
    parser.add_argument('--image_file', default='almond/test_images/')
    if VGG16 == 1:
        parser.add_argument('--model_def',
                            default='models/VGGNet/almond/almond500x500/deploy.prototxt')
        parser.add_argument('--model_weights',
                        default='models/VGGNet/almond/almond500x500/almond_almond500x500_iter_7000.caffemodel')
    else:
        parser.add_argument('--model_def',
